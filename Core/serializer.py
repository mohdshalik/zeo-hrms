...
from .models import(state_mstr,cntry_mstr,crncy_mstr,TaxSystem,document_type,LanguageMaster,Nationality,LanguageSkill,MarketingSkill,ProgrammingLanguageSkill)
#STATE SERIALIZER
